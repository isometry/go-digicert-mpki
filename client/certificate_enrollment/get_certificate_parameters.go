...
// WithSerialNumber adds the serialNumber to the get certificate params
func (o *GetCertificateParams) WithSerialNumber(serialNumber string) *GetCertificateParams {
	o.SetSerialNumber(serialNumber)
	return o
}

// SetSerialNumber adds the serialNumber to the get certificate params
func (o *GetCertificateParams) SetSerialNumber(serialNumber string) {
