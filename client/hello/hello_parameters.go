...
// WithDefaults hydrates default values in the hello params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HelloParams) WithDefaults() *HelloParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hello params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HelloParams) SetDefaults() {
