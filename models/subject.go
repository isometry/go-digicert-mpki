...
func (m *Subject) validateAttributes(formats strfmt.Registry) error {
...
func (m *Subject) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
